...
ExclusiveGatewayHandler.prototype.consume = function(element, processInstanceId) {
...
ExclusiveGatewayHandler.prototype.generate = function(element, processInstanceId) {
  if (!element.sequenceFlow) {
    throw new Error('no sequence flow configured for element ' + element.id);
  }
